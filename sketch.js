...
var knife,fruit ,monster,fruitGroup,monsterGroup, score,r, position;
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    console.log("Monster's Velocity:"+monster.velocityX);
  }
}
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    console.log("Fruits's Velocity:"+fruit.velocityX);
  }
}